...
var or__25966__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj35631 = {"detail":data};
return obj35631;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__25954__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__25954__auto__)){
var and__25954__auto____$1 = (window["CustomEvent"]);
...
var args35636 = [];
var len__27041__auto___35642 = arguments.length;
var i__27042__auto___35643 = (0);
while(true){
if((i__27042__auto___35643 < len__27041__auto___35642)){
args35636.push((arguments[i__27042__auto___35643]));

var G__35644 = (i__27042__auto___35643 + (1));
i__27042__auto___35643 = G__35644;
continue;
} else {
}
break;
...
var f = (function (){var pred__35639 = cljs.core._EQ_;
var expr__35640 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__35639.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__35640))){
return ((function (pred__35639,expr__35640){
return (function (p1__35632_SHARP_){
return console.warn(p1__35632_SHARP_);
});
;})(pred__35639,expr__35640))
} else {
if(cljs.core.truth_(pred__35639.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__35640))){
return ((function (pred__35639,expr__35640){
return (function (p1__35633_SHARP_){
return console.debug(p1__35633_SHARP_);
});
;})(pred__35639,expr__35640))
} else {
if(cljs.core.truth_(pred__35639.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__35640))){
return ((function (pred__35639,expr__35640){
return (function (p1__35634_SHARP_){
return console.error(p1__35634_SHARP_);
});
;})(pred__35639,expr__35640))
} else {
return ((function (pred__35639,expr__35640){
return (function (p1__35635_SHARP_){
return console.log(p1__35635_SHARP_);
});
;})(pred__35639,expr__35640))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__35646){
var map__35649 = p__35646;
...
var opts = map__35649__$1;
var eval_fn = cljs.core.get.call(null,map__35649__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__35651_SHARP_);
});})(new_def))
);
...
return (function (p__35652){
var vec__35653 = p__35652;
var ky = cljs.core.nth.call(null,vec__35653,(0),null);
var v = cljs.core.nth.call(null,vec__35653,(1),null);
...
var args35656 = [];
var len__27041__auto___35659 = arguments.length;
var i__27042__auto___35660 = (0);
while(true){
if((i__27042__auto___35660 < len__27041__auto___35659)){
args35656.push((arguments[i__27042__auto___35660]));

var G__35661 = (i__27042__auto___35660 + (1));
i__27042__auto___35660 = G__35661;
continue;
} else {
}
break;
...
if(cljs.core.truth_((function (){var and__25954__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1513163807399