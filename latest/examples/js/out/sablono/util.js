...
var x__26629__auto__ = (((x == null))?null:x);
var m__26630__auto__ = (sablono.util.to_str[goog.typeOf(x__26629__auto__)]);
if(!((m__26630__auto__ == null))){
return m__26630__auto__.call(null,x);
} else {
var m__26630__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__26630__auto____$1 == null))){
return m__26630__auto____$1.call(null,x);
} else {
...
var x__26629__auto__ = (((x == null))?null:x);
var m__26630__auto__ = (sablono.util.to_uri[goog.typeOf(x__26629__auto__)]);
if(!((m__26630__auto__ == null))){
return m__26630__auto__.call(null,x);
} else {
var m__26630__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__26630__auto____$1 == null))){
return m__26630__auto____$1.call(null,x);
} else {
...
var len__27041__auto___27311 = arguments.length;
var i__27042__auto___27312 = (0);
while(true){
if((i__27042__auto___27312 < len__27041__auto___27311)){
args__27048__auto__.push((arguments[i__27042__auto___27312]));

var G__27313 = (i__27042__auto___27312 + (1));
i__27042__auto___27312 = G__27313;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__27049__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq27310){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq27310));
});
...
var vec__27317 = cljs.core.name.call(null,k).split("-");
...
var first_word = first__27319;
var words = seq__27318__$1;
...
var m__$1 = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__27325){
...
return cljs.core.update.call(null,G__27329,new cljs.core.Keyword(null,"style","style",-496642736),sablono$util$camel_case_keys);
} else {
return G__27329;
}
} else {
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__25966__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1513163798132